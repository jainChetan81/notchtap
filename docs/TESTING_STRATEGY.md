...
## 0. status at a glance (2026-08-03, plan 180 recount — live `cargo test --locked` / `npx vitest run`; this recount absorbs every plan merged since the 171 row above, not only plan 180) — done vs left
