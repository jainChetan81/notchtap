...
## 0. status at a glance (2026-07-28, plan 152 recount — both headline totals recounted from a live `cargo test --locked` / `npx vitest run`; the previous headlines, 871 and 474, had drifted behind their own clause chains) — done vs left
