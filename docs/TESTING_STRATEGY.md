...
## 0. status at a glance (2026-08-03, merged 175+177+178+179 recount resolution — live `cargo test --locked` / `npx vitest run` per branch, totals summed at merge and owed one confirming full run; supersedes the 2026-08-02 plan 171 recount) — done vs left
