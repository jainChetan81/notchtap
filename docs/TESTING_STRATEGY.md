...
<<<<<<< HEAD
## 0. status at a glance (2026-08-03, plan 178 recount — live `cargo test --locked` / `npx vitest run`; supersedes the 2026-08-02 plan 171 recount taken after the tab-notch merge, PR #13) — done vs left
=======
## 0. status at a glance (2026-08-03, plan 177 recount — live `cargo test --locked` / `npx vitest run`) — done vs left
>>>>>>> advisor/177-blank-pull-surfaces
