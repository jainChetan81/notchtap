...
| suite | size | where |
|---|---|---|
| rust unit/integration | 253 tests — settings 45, queue 52, http 27, notifier 23, rss_poller 28, poller 16, event 18, config 17, presentation 11, lib 12, logging 4 | `cargo test` from `src-tauri/` |
