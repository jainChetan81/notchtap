...
## 0. status at a glance (2026-08-02, plan 171 recount — live `cargo test --locked` / `npx vitest run` after the tab-notch merge, PR #13) — done vs left
